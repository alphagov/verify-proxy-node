...
public class EidasAuthnRequestResource {
    ...
    public View handleRedirectBinding(
            @QueryParam(SamlFormMessageType.SAML_REQUEST) @ValidBase64SamlAuthnRequest String encodedEidasAuthnRequest,
    ...
    public View handlePostBinding(
            @FormParam(SamlFormMessageType.SAML_REQUEST) @ValidBase64SamlAuthnRequest String encodedEidasAuthnRequest,
