...
public class ProxyNodeAppRuleTestBase {
    ...
    public EidasProxyNodeAppRule proxyNodeAppRule = new EidasProxyNodeAppRule(
            ...
            ConfigOverride.config("connectorMetadataConfiguration.trustStore.path", truststore.getAbsolutePath()),
            ...
            ConfigOverride.config("hubMetadataConfiguration.trustStore.path", truststore.getAbsolutePath()),
