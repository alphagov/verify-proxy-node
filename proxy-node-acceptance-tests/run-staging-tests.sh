...
export PROXY_NODE_URL="https://proxy-node.integration.eidas.london.verify.govsvc.uk"
export STUB_CONNECTOR_URL="https://stub-connector.integration.eidas.london.verify.govsvc.uk"
