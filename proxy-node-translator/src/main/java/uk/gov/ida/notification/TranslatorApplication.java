...
public class TranslatorApplication extends Application<TranslatorConfiguration> {
    ...
    private MetadataFactory<TranslatorConfiguration> hubMetadataFactory;
    private MetadataFactory<TranslatorConfiguration> connectorMetadataFactory;
    ...
    public void initialize(final Bootstrap<TranslatorConfiguration> bootstrap) {
        ...
        // Metadata
        hubMetadataFactory = new MetadataFactory<>(TranslatorConfiguration::getHubMetadataConfiguration);
        connectorMetadataFactory = new MetadataFactory<>(TranslatorConfiguration::getConnectorMetadataConfiguration);
    ...
    private void registerResources(TranslatorConfiguration configuration, Environment environment) throws Exception {
        ...
        environment.jersey().register(new HubResponseFromGatewayResource(
                ...
                connectorMetadataFactory.getMetadata(),
