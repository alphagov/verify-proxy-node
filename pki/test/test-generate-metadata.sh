...
mkdir -p $VERIFY_HOME/verify-metadata/unsigned/local-proxy-node
cp ./test/.test-metadata/metadata2.xml $VERIFY_HOME/verify-metadata/unsigned/local-proxy-node/metadata.xml
