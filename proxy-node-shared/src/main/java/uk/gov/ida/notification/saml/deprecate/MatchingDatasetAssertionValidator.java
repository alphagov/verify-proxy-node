...
import static uk.gov.ida.notification.saml.deprecate.SamlTransformationErrorFactory.attributeStatementEmpty;
import static uk.gov.ida.notification.saml.deprecate.SamlTransformationErrorFactory.attributeWithIncorrectType;
import static uk.gov.ida.notification.saml.deprecate.SamlTransformationErrorFactory.emptyAttribute;
import static uk.gov.ida.notification.saml.deprecate.SamlTransformationErrorFactory.invalidAttributeNameFormat;
import static uk.gov.ida.notification.saml.deprecate.SamlTransformationErrorFactory.mdsAttributeNotRecognised;
import static uk.gov.ida.notification.saml.deprecate.SamlTransformationErrorFactory.mdsMultipleStatements;
import static uk.gov.ida.notification.saml.deprecate.SamlTransformationErrorFactory.mdsStatementMissing;
